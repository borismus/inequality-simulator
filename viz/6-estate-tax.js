var rules = [
  ...
  {label: 'Estate tax', action: 'this.total -= 0.4 * this.total', condition: ['this.age % 30 == 0', 'this.total > 100']},
  {label: 'Estate tax (age reset)', action: 'this.age = 0', condition: ['this.age % 30 == 0'], hidden: true}
];
